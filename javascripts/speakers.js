var SPEAKERS = {
  "speakers": [
    ...
    },
    {
      ...
      company: 'Stripe',
      twitter: '',
      bio: "Karla works on a cross between security and product engineering at Stripe, building features to protect users from both hackers and themselves. Although she works from Sydney (where the nearest decent snow is at least a 3 hour flight away!), she loves skiing and snowboarding. When it’s too warm for those, she enjoys cross stitching, cooking, and flying tiny little planes.",
    ...
    },
    {
      ...
      company: 'Ad Hoc',
      twitter: '',
      bio: 'Laura Ellena is Ad Hoc’s Research Director, leading UX Researchers to help Veterans access VA benefits they’ve earned on Vets.gov, and helping hospitals report data about their quality of care to the Government. She previously worked on police open data as a 2015 Code for America Fellow, and representing the voice of customers at ModCloth. Her volunteer side jam is helping match volunteer technologists with progressive organizations that can use their help at Ragtag.org. Laura is interested in plain language, hearing strangers’ life stories on public transit, and dresses with pockets.',
    ...
    },
    {
      ...
      company: 'Ad Hoc',
      twitter: '',
      bio: 'Carolyn Williams is a UX Designer at Ad Hoc working with a team to continually improve the experience of HealthCare.gov. The majority of Carolyn’s career has been spent working with government agencies. Notable projects include a top-to-bottom redesign of NASA’s Space App Challenge site. In addition to working alongside the Corporation for National and Community Service to build and launch a campaign celebrating AmeriCorp VISTA’s 50th anniversary. In her spare time she enjoys baking, crossword puzzles, and attending Orioles games.',
